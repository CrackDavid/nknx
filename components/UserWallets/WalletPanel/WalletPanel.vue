    ...
    <div class="wallet-panel">
      <div class="wallet-panel__left">
        ...
        <div class="wallet-panel__value">
          <span v-if="activeWallet">{{
            activeWallet.balance | commaNumber
          }}</span>
          <span v-else>{{ $t('loading') }}</span>
          <span class="wallet-panel__currency">NKN</span>
        </div>
        <div
          v-clipboard:copy="activeWallet.address"
      ...
      <div class="wallet-panel__right">
        ...
        <div class="wallet-panel__button wallet-panel__button_more">
          <span
            class="fe fe-more-vertical wallet-panel__icon wallet-panel__icon_more"
          />
          <span v-if="$mq === 'md' || $mq === 'sm' || $mq === 'xs'">{{
            $t('more')
          }}</span>
        </div>
      </div>
